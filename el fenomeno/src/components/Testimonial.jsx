          ...
          <div className="sm:p-[2rem] p-[1rem]">
            <div className="flex md:flex-row flex-col gap-4">
              ...
              <div className="text-justify">
                <p className={`font-poppins font-normal md:text-[20px] text-[12px] md:leading-[30.8px] leading-[24.8px]`}>TechproCraft`s IT recruitment plan has revolutionized our hiring process. Their comprehensive understanding of our industry and skillful candidate evolution allowed us to attract top IT talent. We are now equipped with a skilled team that drives innovation and fuels our business growth.</p>
              </div>
            </div>
